...
export default function ResetPasswordPage() {
  ...
  const handleUpdatePassword = async () => {
    if (!password.trim() || !confirmPassword.trim()) {
      setStatus("Masukkan password baru dan konfirmasi password.");
      return;
    }
    ...
    setLoading(true);
    setStatus("Memperbarui password...");
    ...
    setStatus("Password berhasil diperbarui. Mengarahkan ke login...");
        ...
        <div className="w-full max-w-[560px] rounded-[2.6rem] border border-white/80 bg-white/90 p-6 shadow-2xl shadow-blue-200/50 backdrop-blur-xl md:p-8">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-md text-sm font-bold leading-7 text-slate-500">
              Masukkan password baru untuk akun KiraServe Anda.
            </p>
          </div>

          {!hasSession && (
            <div className="mt-8 rounded-[1.5rem] bg-gradient-to-br from-red-50 to-orange-50 p-5">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-white text-lg font-black text-red-600 shadow-sm">
                  !
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-bold leading-6 text-red-800">
                    Sesi reset password tidak ditemukan. Link mungkin sudah
                    expired atau sudah pernah digunakan.
                  </p>

                  <p className="mt-1 text-xs font-bold leading-5 text-red-500">
                    Silakan minta link reset password baru dari halaman lupa
                    password.
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.22em] text-blue-500">
                      Reset Session Active
                    </p>

                    <p className="mt-2 text-sm font-bold leading-6 text-blue-800">
                      Link reset valid. Silakan buat password baru.
                    </p>

                    <p className="mt-1 text-xs font-bold leading-5 text-blue-500">
                      Setelah berhasil, Anda akan diarahkan kembali ke login.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-7 grid grid-cols-2 gap-3">
            <InfoPill title="Security" value="New Password" />
            <InfoPill title="Account" value="Protected" />
          </div>

          <p className="mt-6 text-center text-xs font-bold leading-6 text-slate-500">
            Gunakan password yang aman dan jangan bagikan ke orang lain.
          </p>
        </div>
      </section>
    </main>
